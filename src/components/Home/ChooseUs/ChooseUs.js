        ...
        return (
            <div className="home-choose">
                ...
                <div className="home-choose__list">
                    <ChooseItem caption={chooseUs.chooseItem1.title} text={chooseUs.chooseItem1.text} img={hatIMG} />
                    <ChooseItem caption={chooseUs.chooseItem2.title} text={chooseUs.chooseItem2.text} img={bookIMG} />
                    <ChooseItem caption={chooseUs.chooseItem3.title} text={chooseUs.chooseItem3.text} img={worldIMG} />
                    <ChooseItem caption={chooseUs.chooseItem4.title} text={chooseUs.chooseItem4.text} img={supportIMG} />
                </div>
            </div>
        );
    }
